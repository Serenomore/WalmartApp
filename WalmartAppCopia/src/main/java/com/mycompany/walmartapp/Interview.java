...
public class Interview {
    ...
    public void starInterview(){
        ...
        answers.add(JOptionPane.showInputDialog("Indique su nivel de educación y/o títulos que posea"));
        answers.add(JOptionPane.showInputDialog("¿Cuál es su expectativa salarial?"));
